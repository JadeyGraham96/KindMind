			...
			<div className="flip-container-left">
				<div className={`flipper ${this.state.toggle ? "" : "toggle"}`}>
					<div className="front front-left">
						<h2 className="calendar-left-h2">Today</h2>
						<h1 className="calendar-left-h1">{this.props.date.getDate()}</h1>
						<h2 className="calendar-left-h2">{arrDays[this.props.date.getDay()]}</h2>
