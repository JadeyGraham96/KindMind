            ...
            <div class="row" style="padding-top: 0 !important;">
                ...
                <div class="col-md-9">
                    <div class="row" style="width: 98%;float: right;background: #1e1e1e;height: 100%;padding: 3rem;border-radius: 20px;">
                        ...
                        <p style="color: white; width: 100%">Artist: <?php echo $record['Artist']; ?> </p>
                        <p style="color: white; width: 100%">Genre: <?php echo $record['Genre']; ?> </p>
                        <p style="color: white; width: 100%">Review: <?php echo $record['Review']; ?> </p>
                        <p style="color: white; width: 100%">Description: <?php echo $record['Description']; ?> </p>
                    </div>      
                </div>
        </div>
